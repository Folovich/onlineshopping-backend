...
// todo 10 ТАП иммутейбл и патерны применяем. Фактори паттерн добавляем. Стратеги паттерн должен отвечать за 1 дейтсвие за 1 цель как способ платежей. Обязательно применяем синголтон.
//  вашей программе дожно быть DI. Immutable objects add(должен перерывать нашу программу.). История покупок. Добавляем транзакцию в программу ()
public class Main {
